...
namespace Serilog.RabbitMQ.Consumer.MSSqlServer.MSSqlServer
{
    ...
    public static class SqlDataTypes
    {
        ...
        /// </summary>
        public static readonly Dictionary<SqlDbType, Type> SystemTypeMap = new()
        {
            // mapping reference
        ...
        /// </summary>
        public static readonly ReadOnlyCollection<SqlDbType> VariableCharacterColumnTypes = new(new List<SqlDbType> {
            SqlDbType.NVarChar,
            SqlDbType.VarChar
        });
        ...
        /// </summary>
        public static readonly List<SqlDbType> DataLengthRequired =
        [
            SqlDbType.Char,
            SqlDbType.NChar,
            SqlDbType.NVarChar,
        ...
        /// </summary>
        public static readonly Dictionary<Type, SqlDbType> ReverseTypeMap = new()
        {
        ...
        /// </summary>
        public static readonly List<SqlDbType> ColumnstoreCompatible =
        [
