...
namespace Serilog.RabbitMQ.Consumer.MSSqlServer.MSSqlServer
{
    ...
    public class MSSqlServerAuditSink : ILogEventSink, IDisposable
    {
        ...
        //    Consumer.MSSqlServer.MSSqlServer.ColumnOptions.ColumnOptions columnOptions = null,
        ...
        public MSSqlServerAuditSink(
            ...
            ColumnOptions.ColumnOptions columnOptions = null,
        ...
        public void Emit(LogEventWithExceptionAsJsonString logEvent) =>
        ...
        private static void ValidateParameters(MSSqlServerSinkOptions sinkOptions, ColumnOptions.ColumnOptions columnOptions)
        {
            ...
            if (columnOptions.DisableTriggers)
                throw new NotSupportedException(Invariant($"The {nameof(ColumnOptions.ColumnOptions.DisableTriggers)} option is not supported for auditing."));
        }
