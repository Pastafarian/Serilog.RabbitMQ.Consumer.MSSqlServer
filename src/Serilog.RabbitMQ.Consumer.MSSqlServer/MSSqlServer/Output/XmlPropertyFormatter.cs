...
{
    public class XmlPropertyFormatter : IXmlPropertyFormatter
    {
        private static readonly Regex _invalidXMLChars = new(
            @"(?<![\uD800-\uDBFF])[\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x9F\uFEFF\uFFFE\uFFFF]",
            RegexOptions.Compiled);

        public string Simplify(LogEventPropertyValue value, ColumnOptions.ColumnOptions.PropertiesColumnOptions options)
        {
        ...
        private string SimplifyDictionary(ColumnOptions.ColumnOptions.PropertiesColumnOptions options, DictionaryValue dict)
        {
        ...
        private string SimplifySequence(ColumnOptions.ColumnOptions.PropertiesColumnOptions options, SequenceValue seq)
        {
            var sb = new StringBuilder();
        ...
        private string SimplifyStructure(ColumnOptions.ColumnOptions.PropertiesColumnOptions options, StructureValue str)
        {
