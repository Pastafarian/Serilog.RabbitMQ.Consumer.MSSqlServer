...
namespace Serilog.RabbitMQ.Consumer.MSSqlServer.MSSqlServer.Output
{
    public interface ITextFormatterLogEventWithExceptionAsJsonString : ITextFormatter
    {
        ...
        void Format(LogEventWithExceptionAsJsonString logEvent, TextWriter output);
    }

    /// <summary>
    /// Custom JSON formatter to generate content for the LogEvent Standard Column.
    /// </summary>
    internal class JsonLogEventFormatter : ITextFormatterLogEventWithExceptionAsJsonString
    {
        ...
        /// </summary>
        public JsonLogEventFormatter(ColumnOptions.ColumnOptions columnOptions, IStandardColumnDataGenerator standardColumnsDataGenerator)
        {
        ...
        /// </summary>
        public void Format(LogEventWithExceptionAsJsonString logEvent, TextWriter output)
        {
        ...
        private void WriteStandardColumns(LogEventWithExceptionAsJsonString logEvent, TextWriter output, ref string precedingDelimiter)
        {
        ...
        private void WriteIfPresent(StandardColumn col, LogEventWithExceptionAsJsonString logEvent, TextWriter output, ref string precedingDelimiter)
        {
        ...
        private void WriteTimeStampIfPresent(LogEventWithExceptionAsJsonString logEvent, TextWriter output, ref string precedingDelimiter)
        {
        ...
        private KeyValuePair<string, object?> WritePropertyName(LogEventWithExceptionAsJsonString le, TextWriter writer, StandardColumn col)
        {
