...
namespace Serilog.RabbitMQ.Consumer.MSSqlServer.Tests.Misc
{
    ...
    public class IndexingFeaturesTests : DatabaseTestsBase
    {
        ...
        //    var auditService = new AuditService(new Logger<AuditService>(new LoggerFactory()), new RabbitConnectionFactory(new RabbitMqClientConsumerConfiguration()), new MSSqlServerSinkOptions
        //    {
        //        TableName = DatabaseFixture.LogTableName,
        //        AutoCreateSqlTable = true,
        //        BatchPostingLimit = 1,
        //        BatchPeriod = TimeSpan.FromSeconds(10)
        //    }, new SinkDependencies(), new RabbitMqClientConsumerConfiguration(), new AsyncEventingBasicConsumerFactory());
