...
////        using (var file = Serilog.Sinks.File.CreateText("LevelAsEnum.True.Enum.Self.log"))
////        {
...
////        // Act
////        const string loggingInformationMessage = "Logging Information message";
////        using (var file = Serilog.Sinks.File.CreateText("LevelAsEnum.False.Self.log"))
////        {
////            Debugging.SelfLog.Enable(TextWriter.Synchronized(file));
////            Log.Information(loggingInformationMessage);
////            Log.CloseAndFlush();
...
////        // Act
////        const string loggingInformationMessage = "Logging Information message";
////        using (var file = Serilog.Sinks.File.CreateText("LevelAsEnum.Audit.True.Enum.Self.log"))
////        {
////            Debugging.SelfLog.Enable(TextWriter.Synchronized(file));
////            Log.Information(loggingInformationMessage);
////            Log.CloseAndFlush();
...
////        // Act
////        const string loggingInformationMessage = "Logging Information message";
////        using (var file = Serilog.Sinks.File.CreateText("LevelAsEnum.Audit.False.Self.log"))
////        {
////            Debugging.SelfLog.Enable(TextWriter.Synchronized(file));
////            Log.Information(loggingInformationMessage);
////            Log.CloseAndFlush();
