...
namespace Serilog.Sinks.MSSqlServer.Tests
{
    ...
    public class MSSqlServerAuditSinkTests : IDisposable
    {
        ...
        public void InitializeWithoutTableNameThrows()
        {
            Assert.Throws<InvalidOperationException>(() =>
                new MSSqlServerAuditSink(
                    ...
                    new Serilog.RabbitMQ.Consumer.MSSqlServer.MSSqlServer.ColumnOptions.ColumnOptions(),
                    _sinkDependencies));
        }
        ...
        public void InitializeWithDisableTriggersThrows()
        {
            ...
            var columnOptions = new Serilog.RabbitMQ.Consumer.MSSqlServer.MSSqlServer.ColumnOptions.ColumnOptions { DisableTriggers = true };
