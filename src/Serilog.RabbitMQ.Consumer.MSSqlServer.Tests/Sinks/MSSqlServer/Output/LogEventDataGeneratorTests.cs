...
namespace Serilog.RabbitMQ.Consumer.MSSqlServer.Tests.Sinks.MSSqlServer.Output
{
    ...
    public class LogEventDataGeneratorTests
    {
        ...
        private static LogEventWithExceptionAsJsonString CreateLogEvent()
        {
            var timeStamp = new DateTimeOffset(2020, 1, 1, 0, 0, 0, TimeSpan.Zero);
            return new LogEventWithExceptionAsJsonString(new LogEvent(timeStamp, LogEventLevel.Information, null,
